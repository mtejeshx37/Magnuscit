      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-3 px-6 py-3 glass-strong rounded-full border border-[#7000FF]/40 mb-12"
          >
            <Calendar className="w-4 h-4 text-[#D500F9]" />
            <span className="text-white">February 02nd, 2026</span>
            <span className="text-[#D500F9]">•</span>
          ...
          >
            <h1
              className="text-7xl md:text-8xl lg:text-9xl tracking-wider mb-6 relative glitch-text neon-glow-text"
          ...
          {/* Subtitle */}
          <motion.p
            className="text-xl md:text-2xl text-[#94A3B8] mb-16"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            <div className="relative inline-block">
              ...
              <div className="relative glass-strong rounded-3xl px-12 py-8 border-2 border-[#D500F9]/40">
                <div className="flex items-center gap-6 md:gap-12">
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm uppercase tracking-wider" style={{ fontFamily: 'JetBrains Mono, monospace', color: '#FFFFFF' }}>Days</div>
                  </div>

                  <span className="text-4xl" style={{ color: '#FFFFFF' }}>:</span>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm uppercase tracking-wider" style={{ fontFamily: 'JetBrains Mono, monospace', color: '#FFFFFF' }}>Hrs</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm uppercase tracking-wider" style={{ fontFamily: 'JetBrains Mono, monospace', color: '#FFFFFF' }}>Mins</div>
                  </div>
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-sm uppercase tracking-wider" style={{ fontFamily: 'JetBrains Mono, monospace', color: '#FFFFFF' }}>Secs</div>
                  </div>
                </div>
              </div>
            </div>
