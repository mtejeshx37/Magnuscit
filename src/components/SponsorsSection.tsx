                    ...
                    <div className="flex flex-col gap-16">
                        ...
                        >
                            ...
                            <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                                <div className="bg-white rounded-xl p-8 border border-white/10 w-fit hover:shadow-[0_0_30px_rgba(0,209,255,0.3)] transition-shadow duration-300">
                                    <img
                        ...
                        >
                            ...
                            <div className="flex flex-wrap justify-center gap-8 md:gap-12">
                                <div className="bg-white rounded-xl p-8 border border-white/10 w-fit hover:shadow-[0_0_30px_rgba(0,240,255,0.3)] transition-shadow duration-300">
                                    <img
                        ...
                        >
                            ...
                            <div className="bg-white rounded-xl p-8 border border-white/10 w-fit hover:shadow-[0_0_30px_rgba(213,0,249,0.3)] transition-shadow duration-300">
                                <img
                                    src="/junix_logo.png"
                                    alt="Junix"
                                    className="h-24 md:h-32 w-auto object-contain"
