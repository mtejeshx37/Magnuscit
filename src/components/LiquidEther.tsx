...
export default function LiquidEther({
    ...
    const webglRef = useRef<any>(null); // Keeping as any for complex internal class structure
    ...
    useEffect(() => {
        ...
        class AutoDriver {
            ...
            update() {
                ...
                const idle = now - (this.manager as any).lastUserInteraction;
