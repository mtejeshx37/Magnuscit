            ...
            <div className="relative group">
              ...
              <div className="relative bg-[#050505] rounded-2xl overflow-hidden border-2 border-[#D500F9]/30">
                ...
                <div className="relative aspect-[4/3] w-full">
                  <iframe
                    src="https://maps.google.com/maps?q=Chennai%20Institute%20of%20Technology&t=&z=15&ie=UTF8&iwloc=&output=embed"
                    width="100%"
                    height="100%"
                ...
                <div className="absolute top-4 left-4 z-10">
                  <a
                    href="https://www.google.com/maps/search/?api=1&query=Chennai+Institute+of+Technology&query_place_id=ChIJd8pw1TL3UjoRfBu38fL4qTg"
                    target="_blank"
              ...
              <div className="mt-6 relative">
                ...
                <div className="relative bg-gradient-to-br from-[#0a0a0a] to-[#050505] rounded-xl p-6 border border-[#00F0FF]/30">
                  ...
                  <a
                    href="https://www.google.com/maps/dir/?api=1&destination=Chennai+Institute+of+Technology&destination_place_id=ChIJd8pw1TL3UjoRfBu38fL4qTg"
                    target="_blank"
                    rel="noopener noreferrer"
